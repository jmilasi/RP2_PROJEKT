g_l=[];
g_l.MONTHS=["Siječanj","Veljača","Ožujak","Travanj","Svibanj","Lipanj","Srpanj","Kolovoz","Rujan","Listopad","Studeni","Prosinac"];
g_l.DAYS_3=["Ned","Pon","Uto","Sri","Čet","Pet","Sub"];
g_l.MONTH_FWD="Mjesec naprijed";
g_l.MONTH_BCK="Mjesec natrag";
g_l.YEAR_FWD="Godina naprijed";
g_l.YEAR_BCK="Godina natrag";
...
JsDatePick.prototype.getUnUsedGlobalNumber=function(){
	var a=Math.floor(Math.random()*1000);while(!this.isUnique_GlobalNumber(a)){
